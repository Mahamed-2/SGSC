        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {compliance.map((c, i) => (
            <div key={i} className="card p-6 flex items-center gap-4 border-l-4" style={{ 
              borderLeftColor: c.status === "Alert" ? "var(--color-brand)" : "#006633" 
            }}>
              ...
              <div>
                ...
                <div className="flex items-baseline gap-2">
                  ...
                  {c.status === "Alert" && (
                    <span className="text-[10px] font-bold text-danger-DEFAULT bg-danger-light px-1.5 py-0.5 rounded uppercase">Needs Action</span>
                  )}
                </div>
              </div>
            </div>
